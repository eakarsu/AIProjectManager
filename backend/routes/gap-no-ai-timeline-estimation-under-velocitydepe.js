...
const FEATURE_SLUG = 'no-ai-timeline-estimation-under-velocitydepe';
const FEATURE_TITLE = 'No AI timeline estimation under velocity/dependency constraints';
const PROJECT = 'AIProjectManager';
