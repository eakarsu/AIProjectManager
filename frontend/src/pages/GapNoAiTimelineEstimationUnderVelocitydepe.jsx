...
export default function GapNoAiTimelineEstimationUnderVelocitydepe() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-ai-timeline-estimation-under-velocitydepe', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No AI timeline estimation under velocity/dependency constraints</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AIProjectManager - Gap feature</p>
